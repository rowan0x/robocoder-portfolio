          ...
          <div className="w-full max-w-6xl space-y-8 animate-fade-in">
            ...
            <div className="bg-black/80 border border-green-400/30 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 font-mono text-sm">
                <Link href="/about" className="text-cyan-400 hover:bg-cyan-400/10 p-2 rounded block">
                  drwxr-xr-x about_me/
                </Link>
                <Link href="/skills" className="text-green-400 hover:bg-green-400/10 p-2 rounded block">
                  drwxr-xr-x skills_matrix/
                </Link>
                <Link href="/experience" className="text-purple-400 hover:bg-purple-400/10 p-2 rounded block">
                  drwxr-xr-x experience_logs/
                </Link>
                <Link href="/projects" className="text-yellow-400 hover:bg-yellow-400/10 p-2 rounded block">
                  drwxr-xr-x projects_db/
                </Link>
                <Link href="/education" className="text-blue-400 hover:bg-blue-400/10 p-2 rounded block">
                  drwxr-xr-x education_certs/
                </Link>
                <Link href="/contact" className="text-red-400 hover:bg-red-400/10 p-2 rounded block">
